...
fn quote(
    ...
    format!(
        r#"{{"type":"quote","market":"tpex","format":"{format}","symbol":"6488","match_time":"{match_time}","received_at":"2026-07-20T09:00:00.000001+08:00","bids":{bids},"asks":{asks},"deal":{deal},"cum_volume":{cumulative},"limit_flags":{limit},"status_flags":{status},"intermediate_print":{intermediate}}}"#
    )
}
...
fn window_skip_format_and_reserved_flags_are_explicitly_classified() {
    ...
    let outside = quote(
        "STOCK_SNAPSHOT",
        "2026-07-20T08:54:59.999999+08:00",
        false,
        (bids, asks),
        "null",
        0,
