...
usage() {
    cat <<'EOF'
Usage: tools/run_m4_acceptance.sh --output <directory> [--network-runner auto|sandbox-exec]
...
run_logged fixture-integrity "$root/tools/verify_m4_fixture.sh"
...
approver: tools/run_m4_acceptance.sh
EOF
